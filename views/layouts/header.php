                ...
                <div class="col-sm-6">
                    <div class="contactinfo">
                        <ul class="nav nav-pills">
                            <li><a href="#"><i class="fa fa-phone"></i> +1 324 456 63 32</a></li>
                            <li><a href="#"><i class="fa fa-envelope"></i> OnlineShop@gmail.com</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="shop-menu pull-right">
                        <ul class="nav navbar-nav">
                            ...
                            <?php else: ?>
                                ...
                                <?php if (User::isAdmin()) : ?>
                                    <li><a href="/admin/"><i class="fa fa-anchor"></i> Админ панель</a></li>
