...
class CartController{
    ...
    public function actionCheckout()
    {
        ...
        $userPhone = (isset($_POST['userPhone']) && $_POST['userPhone'] != "") ? ($_POST['userPhone']) : null;
        $userComment = (isset($_POST['userComment']) && $_POST['userComment'] != "") ? ($_POST['userComment']) : null;
        // Форма отправлена?
        if (isset($_POST['submit']) && $userName && $userPhone && $userComment) {
            // Форма отправлена? - Да
